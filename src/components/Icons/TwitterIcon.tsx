...
function TwitterIcon(props: IconProps): JSX.Element {
  return (
    <Icon viewBox="0 0 80 64" fill="#1DA1F2" {...props}>
      <path
        d="M25.8,63c28.8,0,44.5-23.9,44.5-44.5c0-0.7,0-1.4,0-2c3.1-2.2,5.7-5,7.8-8.1c-2.8,1.2-5.8,2.1-9,2.5
	c3.2-1.9,5.7-5,6.9-8.7c-3,1.8-6.4,3.1-9.9,3.8C63.2,2.9,59.2,1,54.7,1C46,1,39,8,39,16.7c0,1.2,0.1,2.4,0.4,3.6
